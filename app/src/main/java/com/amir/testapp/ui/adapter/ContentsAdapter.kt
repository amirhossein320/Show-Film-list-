...
class ContentsAdapter() : PagingDataAdapter<Content, ContentsAdapter.ViewHolder>(DiffCallback()) {

    private var context: Context? = null
    var onItemClick: ((Int) -> Unit)? = null
    var onFavoriteItemClick: ((Int, Content) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.contentItem.imgFavorite.setOnClickListener {
            onFavoriteItemClick?.invoke(position, getItem(position)!!)
        }
